<template>
  <div>
    <div class="flex flex-col overflow-y-auto">
      <ul class="relative m-0 p-0 list-none h-full space-y-5">
        <li
          class="text-white text-2xl p-4 w-full flex relative shadow-sm justify-start bg-blue-900 border-b-2 border-blue-700"
        >
          Firebase
        </li>
        <li
          class="text-white p-4 w-full flex relative shadow-sm justify-start bg-blue-900 border-b-2 border-blue-700"
        >
